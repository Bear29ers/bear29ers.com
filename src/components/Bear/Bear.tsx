...
const Bear: FC<Props> = ({ isClicked, setIsClicked }) => {
  ...
  return (
    <div className="relative z-30 size-full ">
      <div
        className={`bear-motion absolute -translate-x-1/2 -translate-y-1/2 ${isClicked ? 'left-[calc(100%-60px)] top-[calc(100%-115px)] scale-[0.65] xsm:top-[calc(100%-100px)] md:left-[calc(100%-80px)] md:top-[calc(100%-110px)] md:scale-[0.8] lg:left-[calc(100%-100px)] lg:top-[calc(100%-130px)] lg:scale-100' : 'left-1/2 top-1/2 scale-100 md:scale-[1.2] lg:scale-150'}`}
        ...
        <div className="flex w-[120px] flex-col gap-y-3.5">
          ...
          <span
            className="z-10 m-auto block h-4 w-[100px] animate-shadow rounded-full bg-white opacity-30 blur-md"
