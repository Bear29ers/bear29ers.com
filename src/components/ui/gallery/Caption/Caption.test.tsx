...
describe('src/components/ui/gallery/Caption/Caption.test.tsx', () => {
  ...
  it('should render username and caption correctly', () => {
    renderResult = render(<Caption media={getMockMedia('bear29ers')} href="/profile/bear29ers" alt="profile-alt" />);
  ...
  it('should render with profile alt when username is missing', () => {
    renderResult = render(<Caption media={getMockMedia()} href="/profile/bear29ers" alt="profile-alt" />);
