...
const ScrollDown: FC<Props> = ({ state, setState }) => {
  return (
    <motion.button
      ...
      className="group absolute bottom-24 left-1/2 z-40 h-28 w-full max-w-[194px] -translate-x-1/2 bg-gradient-to-transparent txs:max-w-[295px] md:bottom-0 md:h-40 mlg:max-w-[337px]"
