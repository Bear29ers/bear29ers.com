    ...
    <div className="flex flex-col items-end">
      ...
      <div className="flex w-full flex-col rounded-b-2xl rounded-tl-2xl bg-blue-300 px-4 pb-4">
        ...
        <div className="-mt-4 flex items-end justify-between">
          ...
          <div className="flex-center h-24 w-24 rounded-full bg-stone-600">
            <svg viewBox="0 0 100 100" className="w-20 overflow-visible">
              <path
                id="circle"
                d="M 10, 50
                a 40,40 0 1,1 80,0
                ...
                fill="none"
              />
              <text fill="#fff" className="text-md font-bold">
