    ...
    <div className="flex flex-col items-end">
      ...
      <div className="flex w-full flex-col rounded-b-2xl rounded-tl-2xl bg-blue-300 px-4 pb-4">
        <div className="relative ml-auto">
          <Image src={Profile} alt={TOP_PROFILE_TEXT.altText} className="relative z-20 h-auto w-72" role="img" />
        ...
        <div className="-mt-4 flex items-end justify-between">
          <div>
            ...
            <h1 className="text-6xl font-semibold text-white">{TOP_PROFILE_TEXT.firstName}</h1>
            <h1 className="text-6xl font-semibold text-white">{TOP_PROFILE_TEXT.lastName}</h1>
            <a
              ...
              <span>{TOP_PROFILE_TEXT.email}</span>
          ...
          <div className="flex-center relative h-24 w-24 rounded-full bg-stone-800">
            <svg viewBox="0 0 100 100" className="w-20 animate-spinSlow overflow-visible">
              ...
              <text fill="#fff" className="text-[15px] font-bold">
                <textPath xlinkHref="#circle">{TOP_PROFILE_TEXT.occupation}</textPath>
              </text>
            </svg>
