...
const Preloader: FC = () => {
  return (
    <div className="flex w-fit">
      <div className="relative mx-4 inline-block size-11 before:absolute before:left-[19px] before:top-[37px] before:size-1.5 before:translate-x-[-18px] before:translate-y-[-18px] before:animate-dotRect before:rounded-full before:bg-[#5628EE] before:content-['']">
        <svg viewBox="0 0 80 80" className="size-full">
          <circle
            ...
            cy="40"
            r="32"
            className="animate-pathCircle fill-none stroke-[#2F3545] stroke-[10]"
      ...
      <div className="relative mx-4 inline-block h-11 w-12 before:absolute before:left-[21px] before:top-[37px] before:size-1.5 before:translate-x-[-10px] before:translate-y-[-18px] before:animate-dotTriangle before:rounded-full before:bg-[#5628EE] before:content-['']">
        <svg viewBox="0 0 86 80" className="size-full">
          <polygon
            points="43 8 79 72 7 72"
            className="animate-pathTriangle fill-none stroke-[#2F3545] stroke-[10]"
      ...
      <div className="relative mx-4 inline-block size-11 before:absolute before:left-[19px] before:top-[37px] before:size-1.5 before:translate-x-[-18px] before:translate-y-[-18px] before:animate-dotRect before:rounded-full before:bg-[#5628EE] before:content-['']">
        <svg viewBox="0 0 80 80" className="size-full">
          <rect
            ...
            width="64"
            height="64"
            className="animate-pathRect fill-none stroke-[#2F3545] stroke-[10]"
