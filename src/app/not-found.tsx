...
const NotFoundPage: NextPage = () => {
  return (
    <div className="h-screen w-screen flex-col bg-dark text-white flex-center">
      <div className="gap-x-36 flex-center">
        <AnimatedText text="4" classes="text-[150px]" />
        <AnimatedText text="4" classes="text-[150px]" />
      </div>
      <div className="relative mr-44 h-28 w-[350px]">
      ...
      <div className="mt-24 flex-col gap-y-8 flex-center">
        ...
        <Link
          href="/"
          className="w-fit rounded-3xl bg-pink-500 px-8 py-2 text-lg font-medium uppercase text-white transition-colors duration-500 ease-in-out hover:bg-pink-400">
          Go Home
        </Link>
      </div>
    </div>
